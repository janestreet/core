(* OASIS_START *)
(* DO NOT EDIT (digest: ad9e2e54a0d15835a972e760e1ea8192) *)
(*
...
let setup_t =
  {
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$rm",
                           ["lib/core_config.mlh"; "lib/core_config.h"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          files_ab = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("sexplib_unix", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\226\193\132r\228\189\254\166w\200\214\220$\151W\b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
