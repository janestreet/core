...
module type S = sig
  ...
  module Zone  : sig
    ...
    (** [abbreviation zone t] returns t abbreviation name such as EDT, EST, JST
        of given [zone] at the time [t].  This string conversion is one-way
  ...
  module Ofday : sig include (module type of struct include Time.Ofday end)
