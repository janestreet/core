...
module Test (S : sig
  ...
  module%test [@name "examples"] _ = struct
  ...
  module%test [@name "duplicates"] _ = struct
  ...
  module%test [@name "unit"] _ = struct
    let sexp_of = Unit.sexp_of_t
  ...
  module%test [@name "bool"] _ = struct
  ...
  module%test [@name "float"] _ = struct
    ...
    let has_class x c =
      ...
      | Infinite, Infinite | Nan, Nan | Normal, Normal | Subnormal, Subnormal | Zero, Zero
        -> true
      | _ -> false
    ;;
  ...
  module%test [@name "string"] _ = struct
  ...
  module%test [@name "char"] _ = struct
  ...
  module%test [@name "tuple2"] _ = struct
  ...
  module%test [@name "option"] _ = struct
  ...
  module%test [@name "function"] _ = struct
    module F =
    ...
    let%test_unit _ = can_generate (fun f -> f 2 > f 1)
    let%test_unit _ = can_generate (fun f -> f (-1) <> f 0 && f 0 <> f 1 && f 1 <> f (-1))
  ...
  module%test [@name "sexp"] _ = struct
  ...
  module%test [@name "function on recursive data"] _ = struct
    ...
    let quickcheck_generator =
      (* memoizing these functions makes [test_no_duplicates] run much faster *)
      G.(fn (List.quickcheck_observer Bool.quickcheck_observer) Char.quickcheck_generator)
  ...
  module%test [@name "deep recursion"] _ = struct
    let test length =
      test
        ~trials:1
...
module _ = struct
  ...
  module Test_data = struct
    ...
    module%test [@name "singleton"] _ = struct
  ...
  module%test [@name "tuple shrinkers"] _ = struct
    open Test_data
  ...
  module%test [@name "variant shrinkers"] _ = struct
    open Test_data
  ...
  module%test [@name "list shrinkers"] _ = struct
    let t0 =
