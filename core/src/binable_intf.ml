...
module type Conv1_without_uuid = sig
  ...
  val to_binable : 'a t @ m -> 'a binable @ m [@@mode m = (global, m)]
...
module type Conv2_without_uuid = sig
  ...
  val to_binable : ('a, 'b) t @ m -> ('a, 'b) binable @ m [@@mode m = (global, m)]
...
module type Conv3_without_uuid = sig
  ...
  val to_binable : ('a, 'b, 'c) t @ m -> ('a, 'b, 'c) binable @ m [@@mode m = (global, m)]
