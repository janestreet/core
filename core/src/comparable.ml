...
struct
  module V = Validate [@modality p] (T)
  include V
...
Map_and_set_binable_using_comparator [@modality p] (struct
    include T
...
module Stable = struct
  module V1 = struct
    ...
    module%template.portable [@modality p] Make (X : Stable_module_types.S0) = struct
