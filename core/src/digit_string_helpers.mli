...
val write_int63 : bytes @ local -> pos:int -> digits:int -> Int63.t -> unit

(** [write_*_digit_int] is like [write_int63] for a hard-coded number of digits and for
    [int] rather than [Int63.t]. *)
val write_1_digit_int : bytes @ local -> pos:int -> int -> unit

val write_2_digit_int : bytes @ local -> pos:int -> int -> unit
val write_3_digit_int : bytes @ local -> pos:int -> int -> unit
val write_4_digit_int : bytes @ local -> pos:int -> int -> unit
val write_5_digit_int : bytes @ local -> pos:int -> int -> unit
val write_6_digit_int : bytes @ local -> pos:int -> int -> unit
val write_7_digit_int : bytes @ local -> pos:int -> int -> unit
val write_8_digit_int : bytes @ local -> pos:int -> int -> unit
val write_9_digit_int : bytes @ local -> pos:int -> int -> unit
...
val read_int63 : string @ local -> pos:int -> digits:int -> Int63.t

(** [read_*_digit_int] is like [read_int63] for a hard-coded number of digits and for
    [int] rather than [Int63.t]. *)
val read_1_digit_int : string @ local -> pos:int -> int

val read_2_digit_int : string @ local -> pos:int -> int
val read_3_digit_int : string @ local -> pos:int -> int
val read_4_digit_int : string @ local -> pos:int -> int
val read_5_digit_int : string @ local -> pos:int -> int
val read_6_digit_int : string @ local -> pos:int -> int
val read_7_digit_int : string @ local -> pos:int -> int
val read_8_digit_int : string @ local -> pos:int -> int
val read_9_digit_int : string @ local -> pos:int -> int
